...
<div class="page cell">
  ...
  <div class="bd">
    ...
    <cells type="split">
      <cell>
        <cell-header><img :src="sampleImage" alt="" style="width:20px;margin-right:5px;display:block"></cell-header>
        <cell-body>标题文字</cell-body>
        <cell-footer>说明文字</cell-footer>
      </cell>
      <cell>
    ...
    <cells type="access">
      <cell link="javascript:;">
        <cell-body>cell standard</cell-body>
...
import {ButtonArea, Button,
  ...
  CellHeader, CellBody, CellFooter, CellInput,
